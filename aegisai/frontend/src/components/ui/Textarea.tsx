    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          id={inputId}
          className={clsx(
            'w-full rounded-lg border bg-white px-4 py-2.5 text-sm text-dark-900 placeholder:text-dark-400 transition-colors duration-200 focus:outline-none focus:ring-2 resize-y min-h-[100px]',
            error
